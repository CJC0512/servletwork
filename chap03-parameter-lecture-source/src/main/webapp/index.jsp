...
<form action="querystring" method="get">
    ...
    <!-- 설명. 버튼 태그는 type이라는 속성이 없으면 기본적으로 submit 버튼이다. -->
    <%-- 필기. 입력 후, 버튼을 누르면 다음과 같은 주소로 값이 정리된다. (querystring)
    http://localhost:8080/chap03/querystring?name=%ED%99%8D%EA%B8%B8%EB%8F%99&age=20&birthday=2024-02-07&gender=M&national=ko&hobbies=movie&hobbies=music--%>
