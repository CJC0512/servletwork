...
public class SessionHandlerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /* 필기. req의 Cookie에 JSessionID가 존재 */
        /* 설명. 요청이 서블릿으로 들어올 때, HTTPServletRequest에는 JSESSIONID라는 값이
        *       Header에 같이 포함되어 넘어온다. 그럼 해당 JSESSIONID에 맞는 HTTPSession 객체를
        *       생성해서 해당 사용자를 위한 전용 저장 공간을 제공하게 된다.
